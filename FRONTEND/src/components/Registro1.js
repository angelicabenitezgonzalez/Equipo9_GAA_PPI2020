  ...
  return (
    <div className="Registro py-5 text-center mb-4">
      ...
      <form className="form-signin">
        <img className="mb-4" src="./imagenes9/icono-iniciar.png" alt="Logo" width="200" height="200" />
        ...
        <p>
                <Link class="btn btn-success" to="/Listah1" role="button">
                  <font className="Leisy:)">
                    <font className="Leisy:)">Registrarse</font>
                  </font>
                </Link>
              </p>
              <p>
                <Link class="btn btn-primary" to="/Registroc" role="button">
                  <font className="Leisy:)">
                    <font className="Leisy:)">Registrarse</font>
                  </font>
                </Link>
